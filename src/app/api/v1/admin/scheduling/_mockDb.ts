...
export const mockServices: Service[] = [
  ...
  {
    id: 'svc-private-hire-1',
    tenantId,
    locationId: mockLocations[0].id,
    categoryId: mockCategories[0].id,
    category: mockCategories[0],
    serviceType: 'PRIVATE_HIRE' as ServiceType,
    bookingMode: 'SCHEDULED' as BookingMode,
    name: 'Venue private hire',
    ...
    minAdvanceHours: null,
    maxAdvanceHours: null,
    metadata: { facilities: ['Party room', 'Sound system', 'Kitchen access'], depositPercent: 25 },
    createdAt: nowIso(),
    deletedAt: null,
  },
]
...
const privateHireService = mockServices.find(s => s.id === 'svc-private-hire-1')!

export let standaloneBookings: Booking[] = [
  {
    id: 'bk-private-hire-pending-1',
    tenantId,
    bookingType: 'PRIVATE_HIRE' as BookingType,
    serviceSlotId: null,
    serviceId: privateHireService.id,
    service: privateHireService,
    contactId: 'ctc-ph-1',
    contact: { id: 'ctc-ph-1', firstName: 'Sam', lastName: 'Rivera' },
    participantContactId: null,
    participantContact: null,
    locationId: mockLocations[0].id,
    status: 'PENDING' as BookingStatus,
    startAt: addMinutes(startBase, 72 * 60),
    endAt: addMinutes(startBase, 72 * 60 + 240),
    guestCount: 45,
    totalAmount: '0.00',
    depositAmount: null,
    balanceDue: '500.00',
    ...
    cancellationReason: null,
    checkedInAt: null,
    notes: 'Birthday party — need bounce house area.',
    internalNotes: null,
    metadata: { alternateDate: addMinutes(startBase, 96 * 60), eventType: 'Birthday Party' },
    source: BookingSource.ONLINE,
    addOns: [],
  },
  {
    id: 'bk-private-hire-confirmed-1',
    tenantId,
    bookingType: 'PRIVATE_HIRE' as BookingType,
    serviceSlotId: null,
    serviceId: privateHireService.id,
    service: privateHireService,
    contactId: 'ctc-ph-2',
    contact: { id: 'ctc-ph-2', firstName: 'Alex', lastName: 'Morgan' },
    participantContactId: null,
    participantContact: null,
    locationId: mockLocations[1].id,
    status: 'CONFIRMED' as BookingStatus,
    startAt: addMinutes(startBase, 120 * 60),
    endAt: addMinutes(startBase, 120 * 60 + 240),
    guestCount: 30,
    totalAmount: '125.00',
