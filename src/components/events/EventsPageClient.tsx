...
export default function EventsPageClient() {
  ...
  return (
    <div className='dt-font-body bg-[var(--dt-bg-page)] min-h-screen'>
      <Hero 
        title={<>Events & <em className='not-italic text-[var(--dt-hero-accent)]'>Parties</em></>} 
        ...
        actions={
          <>
            ...
            <ActionLink href='#packages' variant='outline' className='dt-btn-hero-outline px-7 py-3.5 text-sm !text-white border-white/30 bg-white/10'>
              View Packages
            </ActionLink>
          </>
        }
      ...
      <div className='max-w-[1200px] mx-auto px-6 py-8 pb-20'>
        <FlowSteps
          ...
          steps={[
            { title: 'Choose a format', description: 'Start with room packages, full buyouts, takeout parties, or mobile setups.' },
            { title: 'Add upgrades', description: 'Use add-ons and party extras to shape the event around budget and guest count.' },
            { title: 'Submit the request', description: 'Open the booking flow with the package selected and send the event details.' },
          ]}
        />
