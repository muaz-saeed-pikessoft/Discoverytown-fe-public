  ...
  return (
    <div className='grid grid-cols-2 gap-4 max-md:grid-cols-1'>
      {items.map(item => (
        <div
          key={item.title}
          className='rounded-2xl border border-[var(--dt-border)] bg-white p-6 shadow-sm flex gap-4 items-start'
        >
    ...
    <div className='min-h-screen bg-[var(--dt-bg-page)] dt-font-body'>
      <Hero
        ...
        actions={
          <a
            href='/contact'
            className='inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-[var(--dt-coral)] text-white text-sm font-bold no-underline'
          >
            Get a Custom Quote
          </a>
        }
