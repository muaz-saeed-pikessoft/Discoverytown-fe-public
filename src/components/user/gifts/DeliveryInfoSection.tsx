...
export default function DeliveryInfoSection() {
  return (
    <>
      <SectionHeader eyebrow='Delivery Info' title='How It Works' accentColor='var(--dt-coral)' />
      <div className='grid grid-cols-1 gap-4 sm:grid-cols-3'>
        {DELIVERY_INFO.map(info => (
          <div key={info.title} className='rounded-[16px] border border-[var(--dt-border)] bg-white p-6 shadow-sm'>
