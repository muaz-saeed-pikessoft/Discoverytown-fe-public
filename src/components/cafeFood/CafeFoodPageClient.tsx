...
export default function CafeFoodPageClient() {
  ...
  return (
    <div className='dt-font-body bg-[var(--dt-bg-page)] min-h-screen'>
      <Hero 
        title={<>A Real <em className='not-italic text-[var(--dt-hero-accent)]'>Cafe Menu</em> for Family Days</>}
        ...
        actions={
          <>
            ...
            <ActionLink href='#delivery' variant='outline' className='dt-btn-hero-outline px-7 py-3.5 text-sm !text-white border-white/30 bg-white/10'>
              Delivery &amp; Catering
            </ActionLink>
          </>
        }
      ...
      <div className='max-w-[1200px] mx-auto px-6 py-8 pb-28 flex flex-col gap-5'>
        <FlowSteps
          ...
          steps={[
            { title: 'Build the cart', description: 'Add drinks, food, and treats from the menu boards and item cards.' },
            { title: 'Choose fulfillment', description: 'Set pickup or delivery, preferred timing, and add any allergy or event notes.' },
            { title: 'Submit the request', description: 'Review totals in the order panel and send the frontend cafe request.' },
          ]}
        />
