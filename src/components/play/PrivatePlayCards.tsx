  ...
  return (
    ...
    >
      ...
      <div className='px-5 py-5'>
        <h3 className='dt-font-heading text-[17px] font-black text-[var(--dt-dark)] leading-[1.3] mb-4'>
          {opt.name}
        </h3>
        <ActionLink href={`/book?service=private-play&option=${opt.slug}`} accentColor='var(--dt-blue-mid)' className='w-full py-3 text-[13px]'>
          Inquire Now →
        </ActionLink>
      </div>
    </div>
