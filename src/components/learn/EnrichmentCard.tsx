...
import type { EnrichmentCourse, ColorSet } from './types'

export default function EnrichmentCard({ course, colorSet }: EnrichmentCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className='px-5 py-5 flex flex-col h-[calc(100%-180px)]'>
        ...
        <p className='text-[13px] leading-[1.6] text-[var(--dt-text-muted)] mt-auto'>{course.desc}</p>
      </div>
    </div>
  )
}
