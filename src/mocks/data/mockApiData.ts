...
export const MOCK_RAW_BOOKINGS: RawBookingResponse[] = [
  {
    ...
    guests: [
      { id: 'g1', full_name: 'Emma Johnson', age: 6, relationship: 'Child' },
      { id: 'g2', full_name: 'Liam Johnson', age: 4, relationship: 'Child' },
    ],
  },
  {
    id: 'bk-upcoming-1',
    ...
    time_range: '9:30 AM – 10:15 AM',
    status: 'confirmed',
    total_amount: 25,
    confirmation_code: 'DT-26-MUS-01',
    guests: [{ id: 'g1', full_name: 'Emma Johnson', age: 6, relationship: 'Child' }],
  },
  {
    id: 'bk-upcoming-2',
    booking_type: 'event',
    ...
    status: 'confirmed',
    total_amount: 45,
    confirmation_code: 'DT-26-EVT-01',
    guests: [
      { id: 'g1', full_name: 'Emma Johnson', age: 6, relationship: 'Child' },
      { id: 'g2', full_name: 'Liam Johnson', age: 4, relationship: 'Child' },
    ],
  },
  {
    id: 'bk-upcoming-3',
    booking_type: 'party',
    title: "Liam's Half-Birthday Party",
    scheduled_date: '2026-04-20',
    time_range: '1:00 PM – 3:30 PM',
    status: 'confirmed',
    total_amount: 350,
    confirmation_code: 'DT-26-PRT-02',
    guests: [{ id: 'g2', full_name: 'Liam Johnson', age: 4, relationship: 'Birthday Child' }],
  },
  {
    id: 'bk-past-1',
    booking_type: 'drop-in',
    title: 'Weekend Play Pass',
    scheduled_date: '2026-02-15',
    time_range: '10:00 AM – 4:00 PM',
    status: 'completed',
    total_amount: 45,
    confirmation_code: 'DT-26-PST-01',
    guests: [{ id: 'g1', full_name: 'Emma Johnson', age: 6, relationship: 'Child' }],
  },
  {
    id: 'bk-cancelled-1',
    ...
    status: 'cancelled',
    total_amount: 0,
    confirmation_code: 'DT-26-CNC-01',
    guests: [{ id: 'g2', full_name: 'Liam Johnson', age: 4, relationship: 'Child' }],
  },
]
